...
{
	double laudanArvo = 0;
	// Heinin kommentti: kertoimet asetettu sen takia että niiden avulla asioiden painoarvoa voidaan säätää helposti yhdestä paikasta
...
void Asema::annaLinnoitusSiirrot(std::list<Siirto>& lista, int vari)
{
		...
		//pitkän valkoisen linnotuksen lisääminen lailliseksi siirroksi
		if (vari == 0  
		...
		//lyhyt valkoisen linnotuksen lisääminen lailliseksi siirroksi
		if (vari == 0 
		...
		//pitkän musta linnotuksen lisääminen lailliseksi siirroksi
		if (vari == 1 
		...
		//lyhyt musta linnotuksen lisääminen lailliseksi siirroksi
		if (vari == 1 
